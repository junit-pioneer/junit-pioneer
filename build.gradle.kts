...
dependencies {
    ...
    implementation(group = "org.junit.platform", name = "junit-platform-commons", version = "1.4.2")
    implementation(group = "org.junit.platform", name = "junit-platform-engine", version = "1.4.2")
