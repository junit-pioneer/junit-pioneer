...
import org.gradlex.javamodule.testing.JavaModuleTestingExtension
...
val patchModuleArg = "--patch-module=$moduleName=${tasks.compileJava.get().destinationDirectory.asFile.get().path}"
