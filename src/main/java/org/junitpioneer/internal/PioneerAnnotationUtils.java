...
public class PioneerAnnotationUtils {
	...
	/**
	 * Checks whether the given annotation is a containing annotation type.
	 * This implementation does not check retention, target, documented, or inherited meta-annotations.
	 *
	 * @see <a href="https://docs.oracle.com/javase/specs/jls/se21/html/jls-9.html#jls-9.6.3l">Java Language Specification
	 * Section 9.6.3.</a> Repeatable Annotation Interfaces
	 */
