...
[source,java]
----
include::{demo}[indent=0, tag=retrying_failsNever]
----
...
[source,java]
----
include::{demo}[indent=0, tag=retrying_fails_on_first_but_passes_on_second]
----
...
[source,java]
----
include::{demo}[indent=0, tag=retrying_fails_always]
----
...
[source,java]
----
include::{demo}[indent=0, tag=retrying_aborted]
----
...
[source,java]
----
include::{demo}[indent=0, tag=retrying_configure_numbers_of_success]
----
...
[source,java]
----
include::{demo}[indent=0, tag=retrying_configure_exception_for_retry]
----
