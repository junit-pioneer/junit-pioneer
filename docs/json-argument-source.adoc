...
To pull in a parser, add the Jackson dependency directly:
...
[NOTE]
Before 3.0, Pioneer used a Gradle feature variant as an option.
That has been removed in 3.0 for the sake of simplicity.
