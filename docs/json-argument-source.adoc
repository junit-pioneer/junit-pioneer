...
[source,java]
----
include::{jedi}[indent=0, tag=class]
----
...
[source,java]
----
include::{json-demo}[indent=0, tag=classpath_source,indent=0]
----

[source,java]
----
include::{json-demo}[indent=0, tag=inline_source,indent=0]
----
...
[source,java]
----
include::{json-demo}/[indent=0, tag=classpath_source_with_property,indent=0]
----

[source,java]
----
include::{json-demo}[indent=0, tag=inline_source_with_property,indent=0]
----
...
[source,java]
----
include::{json-demo}[indent=0, tag=classpath_source_deconstruct_from_array,indent=0]
----

[source,java]
----
include::{json-demo}[indent=0, tag=inline_source_deconstruct_from_array,indent=0]
----
...
[source,java]
----
include::{json-demo}[indent=0, tag=classpath_source_nested_data,indent=0]
----
