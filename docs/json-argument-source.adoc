...
:xp-demo-dir: ../src/demo
:json-demo-java: {xp-demo-dir}/java/org/junitpioneer/jupiter/json
:json-demo-resources: {xp-demo-dir}/resources
:json-demo: {json-demo-java}/JsonArgumentSourceExtensionDemo.java
...
[source,java]
----
include::{json-demo-java}/Jedi.java[tag=class]
----
