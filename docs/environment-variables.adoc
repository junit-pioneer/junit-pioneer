...
[source,java]
----
include::{demo}[indent=0, tag=environment_clear_simple]
----
...
[source,java]
----
include::{demo}[indent=0, tag=environment_set_simple]
----
...
[source,java]
----
include::{demo}[indent=0, tag=environment_using_set_and_clear]
----
...
[source,java]
----
include::{demo}[indent=0, tag=environment_using_at_class_level]
----
