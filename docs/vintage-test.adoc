...
[source,java]
----
include::{demo}[indent=0, tag=vintage_test_indexoutofbound_exception]
----
...
[source,java]
----
include::{demo}[indent=0, tag=vintage_test_runtime_exception]
----
...
[source,java]
----
include::{demo}[indent=0, tag=vintage_test_iae_exception]
----
...
[source,java]
----
include::{demo}[indent=0, tag=vintage_test_timeout]
----
...
[source,java]
----
include::{demo}[indent=0, tag=vintage_test_timeout_loop]
----
