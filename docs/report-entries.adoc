...
----
include::{demo}[indent=0, tag=no_report_entry]
----
...
[source,java,indent=0]
----
include::{demo}[indent=0, tag=report_entry_basic]
----
...
[source,java,indent=0]
----
include::{demo}[indent=0, tag=report_entry_multiple]
----
...
[source,java,indent=0]
----
include::{demo}[indent=0, tag=report_entry_with_key]
----
...
[source,java,indent=0]
----
include::{demo}[indent=0, tag=report_entry_publish_condition]
----
...
[source,java,indent=0]
----
include::{demo}[indent=0, tag=report_entry_for_params]
----
