...
:snippetsource: ../demo/src/test/java/org/junitpioneer/jupiter/ReportEntryExtensionTests.java
...
----
include::{snippetsource}[tag=no_report_entry]
----
...
[source,java,indent=0]
----
include::{snippetsource}[tag=report_entry_basic]
----
...
[source,java,indent=0]
----
include::{snippetsource}[tag=report_entry_multiple]
----
...
[source,java,indent=0]
----
include::{snippetsource}[tag=report_entry_with_key]
----
...
[source,java,indent=0]
----
include::{snippetsource}[tag=report_entry_publish_condition]
----
...
[source,java,indent=0]
----
include::{snippetsource}[tag=report_entry_for_params]
----
