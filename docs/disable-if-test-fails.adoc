...
[source,java]
----
include::{demo}[indent=0, tag=disable_if_test_fails]
----
...
[source,java]
----
include::{demo}[indent=0, tag=disable_if_test_not_on_assertions]
----
...
[source,java]
----
include::{demo}[indent=0, tag=disable_if_test_with_given_exception]
----
