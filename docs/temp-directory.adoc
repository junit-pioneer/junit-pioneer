...
Alternatively, rather than typing out all of `@New(TemporaryDirectory.class)`, you can use the shorthand annotation `@Dir` instead.
...
`@Dir` annotations do not yet support arguments. Follow https://github.com/junit-pioneer/junit-pioneer/issues/648[this issue] for updates on this feature.
