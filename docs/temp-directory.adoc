...
NOTE: JUnit Jupiter 5.4 introduced a https://junit.org/junit5/docs/current/user-guide/#writing-tests-built-in-extensions-TempDirectory[built-in `@TempDir` extension].
...
We tackled this problem again since then and introduced a link:docs/resource[resource]-based extension - link:docs/resource-temporary-directory[see here].
