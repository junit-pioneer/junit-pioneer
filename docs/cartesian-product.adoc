...
include::{demo}[indent=0, tag=cartesian_simple_demo]
----
...
include::{demo}[indent=0, tag=cartesian_annotating_parameters]
----
...
include::{demo}[indent=0, tag=cartesian_combining_values]
----
...
include::{demo}[indent=0, tag=cartesian_with_enum]
----
...
include::{demo}[indent=0, tag=cartesian_enum_with_type]
----
...
include::{demo}[indent=0, tag=cartesian_enum_with_type_and_names]
----
...
include::{demo}[indent=0, tag=cartesian_enum_with_mode]
----
...
include::{demo}[indent=0, tag=cartesian_enum_with_regex]
----
...
include::{demo}[indent=0, tag=cartesian_enum_with_enums]
----
...
include::{demo}[indent=0, tag=cartesian_enum_with_range_sources]
----
...
[source,java]
----
include::{demo}[indent=0, tag=cartesian_argument_sets]
----
...
[source,java]
----
include::{demo}[indent=0, tag=cartesian_argument_sets_reuse]
----
...
[source,java]
----
include::{demo}[indent=0, tag=cartesian_bad_examples]
----
...
include::{demo}[indent=0, tag=cartesian_argument_sets_int_argument_provider]
----
...
include::{demo}[indent=0, tag=cartesian_argument_sets_ints_annotation]
----
...
include::{people}[indent=0, tag=cartesian_people_provider_with_CartesianParameterArgumentsProvider]
----
...
include::{people}[indent=0, tag=cartesian_people_provider_with_AnnotationConsumer]
----
...
include::{bit}[indent=0, tag=cartesian_bit_source_annotation]
----
...
include::{bit}[indent=0, tag=cartesian_bit_argument_provider]
----
...
include::{number}[indent=0, tag=cartesian_number_argument_provider]
----
...
include::{demo}[indent=0, tag=cartesian_testWithCustomDisplayName]
----
