...
NOTE: The CartesianTest extension has undergone significant changes in 1.4.3 (??? TODO: Fix).
...
You can annotate your test parameters with link:range-sources.adoc[range source annotations].
