...
This extension will call this method when a test with a `@New`- or `@Shared`-annotated parameter is about to run.
The extension will then populate the parameter with the contents of this resource.
...
You have full control over what these arguments mean and how they are used.
You should document these details in your resource factory's JavaDocs.
