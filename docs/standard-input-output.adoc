...
[source,java]
----
include::{demo}[indent=0, tag=stdio_stdin_replace_input]
----
...
[source,java]
----
include::{demo}[indent=0, tag=stdio_stdin_replace__and_verify_input]
----
...
[source,java]
----
include::{demo}[indent=0, tag=stdio_stdin_not_replaced_but_stdout]
----
...
[source,java]
----
include::{demo}[indent=0, tag=stdio_both_replaced]
----
...
[source,java]
----
include::{demo}[indent=0, tag=stdio_both_replaced_and_verify]
----
...
[source,java]
----
include::{demo}[indent=0, tag=stdio_edge_cases_ExampleConsoleReader]
----
...
[source, java]
----
include::{demo}[indent=0, tag=stdio_edge_cases_ConsoleReaderTest]
----
