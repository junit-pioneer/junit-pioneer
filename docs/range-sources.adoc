...
[source,java]
----
include::{demo}[indent=0, tag=rangesources_int_valid_digit]
----
...
[source,java]
----
include::{demo}[indent=0, tag=rangesources_double_with_step]
----
...
[source,java]
----
include::{demo}[indent=0, tag=rangesources_ranges]
----
