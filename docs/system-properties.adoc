...
NOTE: Since v1.7.0, class-level configurations mean that the corresponding system properties variables are cleared/set before and reset after each individual test in the annotated class.
