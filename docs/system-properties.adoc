...
However, it is OK and normal to use all three annotations together, which you might do if some property values parameterized (i.e. need to be set in code) and others are not.
