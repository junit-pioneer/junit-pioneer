...
[source,java]
----
include::{demo}[indent=0, tag=systemproperty_clear_simple]
----
...
[source,java]
----
include::{demo}[indent=0, tag=systemproperty_set_simple]
----
...
[source,java]
----
include::{demo}[indent=0, tag=systemproperty_using_set_and_clear]
...
[source,java]
----
include::{demo}[indent=0, tag=systemproperty_using_at_class_level]
----
...
[source,java]
----
include::{demo}[indent=0, tag=systemproperty_parameter]
----
